...
public class PathfinderGoalFollowSnowman extends PathfinderGoal {

    private EntitySnowmanPet d;
    ...
    public PathfinderGoalFollowSnowman(EntitySnowmanPet entitySnowmanPet, float f, float f1, float f2) {
        this.d = entitySnowmanPet;
        this.a = entitySnowmanPet.world;
        this.f = f;
        this.g = entitySnowmanPet.getNavigation();
        this.c = f1;
        this.b = f2;
        this.a(3);
    }
